...
use app\common\model\viral_fission\FissionQueue as  FissionQueueModel;
use think\Db;

class FissionQueue extends Backend
{
    public $model = null;
    ...
    {
        parent::_initialize();
        $this->model =new FissionQueueModel();
    }
...
//
        ...
        $class_list =   $this->model->group('class_name')->column('job_name', 'queue_name');
