...
class MaterialConsumption extends Backend
{
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $query = $this->model
                ->alias('gm')
                ->field('gm.adv_id,gm.material_id,gm.stat_cost_for_roi2,gm.cost_date,total_pay_order_count_for_roi2,total_prepay_and_pay_order_roi2, IF(dm.adopt_material_id IS NULL, 0, 1) AS is_fission,com.company_name,com.kahuna,com.store_id,com.first_industry_name,com.second_industry_name')
