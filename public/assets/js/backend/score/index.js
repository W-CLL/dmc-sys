            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'reason', title: "审核拒绝原因",width: '300'     ,
                            formatter: function (value, row, index, field) {
                                return "<span style='display: block;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;' title='" + row.reason + "'>" + value + "</span>";
                            },
                        ...
                        {field: 'one_class_score', title: "(严重)违规",sortable:true,formatter: function (value, row, index) {
                                if (value >=6 && row.adv_status != "已禁用") {
                                    return '<span style="color:red;">' +value+'</span>';
                                }
                                return value;
                            }},
                        {field: 'two_three_class_score', title: "(一般)违规",sortable:true,formatter: function (value, row, index) {
                                if (value >=24 && row.adv_status != "已禁用" ) {
                                    return '<span style="color:#E7B524FF;">' +value+'</span>';
                                }
                                return value;
