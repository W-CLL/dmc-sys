define(['jquery', 'bootstrap', 'store', 'addtabs', 'adminlte', 'form'], function ($, undefined, Store, undefined, AdminLTE, Form) {
    var Controller = {
        index: function () {
            //双击重新加载页面
            ...
            $("form.sidebar-form").on('mousedown click', '.menuresult a[data-url]', function () {
                Store.api.addtabs($(this).data("url"));
            });
            ...
            if (Config.referer) {
                if (Config.referer === $(addtabs).attr("url")) {
                    ...
                    //刷新页面后跳到到刷新前的页面
                    Store.api.addtabs(Config.referer);
                }
            }
            ...
            $('#password_save').click(function(){
                layer.open({
                    ...
                    yes: function(index, layero){
                        ...
                        var passwords = body.find("input[name='passwords']")[0].value;
        ...
        login: function () {
            ...
            if (lastlogin) {
                ...
                $("#profile-img").attr("src", Store.api.cdnurl(lastlogin.avatar));
            ...
            Form.api.bindevent($("#login-form"), function (data) {
                ...
                location.href = Store.api.fixurl(data.url);
            }, function (data) {
